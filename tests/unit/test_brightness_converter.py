...
def test_brightness_ascii_output_shape():
    ...
    expected_height = int(40 / 2)  # matches aspect ratio correction
...
def test_brightness_ascii_dark_to_light():
    ...
    # Dark image should only contain darkest character '@'
    assert set(dark_ascii.replace("\n", "")) == {"@"}

    # Light image should only contain lightest character ' '
